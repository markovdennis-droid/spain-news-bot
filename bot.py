...
- ИГНОРИРУЙ новости о других странах (Британия, США, Россия и т.д.) если они не связаны с Испанией напрямую.
...
- Приоритет: 1) новости из Испании, 2) новости об испанцах за рубежом (спортсмены, компании, культура), 3) анонс ближайшего события в Испании. НИКОГДА не пиши «без новостей» или «ничего не найдено» — всегда находи что-то интересное.
"""
